...
export class DsDatepicker implements OnDestroy, CanColor {
  ...
  private _dialogRef: MatDialogRef<DsDatepickerContent> | null

  /** Reference to the component instantiated in popup mode. */
  private _popupComponentRef: ComponentRef<DsDatepickerContent> | null
  ...
  _datepickerInput: DsDatepickerInput
   ...
   */
  _registerInput(input: DsDatepickerInput): void {
    if (this._datepickerInput) {
      throw Error('A DsDatepicker can only be associated with a single input.')
    }
  ...
  private _openAsDialog(): void {
    ...
    this._dialogRef = this._dialog.open<DsDatepickerContent>(
      DsDatepickerContent,
      {
  ...
  private _openAsPopup(): void {
    const portal = new ComponentPortal<DsDatepickerContent>(
      DsDatepickerContent,
