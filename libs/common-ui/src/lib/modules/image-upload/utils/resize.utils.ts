/**
 * @description Fast image resize/resample using Hermite filter.
 * @param {HTMLCanvasElement} canvas
 * @param {number} width
 * @param {number} height
 * @param {boolean} shouldRezize
 * @see {@link https://github.com/viliusle/Hermite-resize}
 */
