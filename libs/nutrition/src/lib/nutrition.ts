...
export interface Fats<T> extends SaturatedFat<T>, MonoUnsaturated<T>, PolyUnsaturated<T>, TransUnsaturated<T> {
  fat?: T;
  fat_nlea?: T;
  saturatedFat?: T;
  polyUnsaturated?: T;
...
export interface Vitamins<T> extends VitaminA<T>, VitaminD<T>, VitaminE<T>, Folate<T> {
  vit_A?: T;
  vit_C?: T;
  vit_D?: T;
  vit_E?: T;
...
export interface Nutrition<T> extends Energy<T>, Carbohydrates<T>, Fats<T>, Protein<T>, Vitamins<T>, Minerals<T>, Sterols<T>, Others<T> {
