...
import {
  BrowserWindowRef,
  WINDOW,
} from '../../../cc-ng-core/src/lib/window.service';
...
@Component({
  template: `
    <div id="app-root">
      ...
      <div class="drop" [ccDrop]="dropData">drop</div>
    </div>
  `,
})
...
describe('Drag and Drop directives', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      imports: [DragNDropModule.forRoot()],
      providers: [{ provide: WINDOW, useClass: BrowserWindowRef }],
    });
