  ...
  [
    ...
    animate(
      ...
      keyframes([
        ...
        style({ transform: 'perspective(400px) scale3d(1.5, 1.5, 1.5) rotate3d(0, 1, 0, -190deg)', offset: 0.4 }),
        style({ transform: 'perspective(400px) scale3d(1.5, 1.5, 1.5) rotate3d(0, 1, 0, -170deg)', offset: 0.5 }),
        style({ transform: 'perspective(400px) scale3d(0.95, 0.95, 0.95)', offset: 0.8 }),
...
export function flipIn(rotateX: number, rotateY: number): AnimationReferenceMetadata {
  return animation(
    [
      style({ 'backface-visibility': 'visible' }),
      animate(
        ...
        keyframes([
          ...
          style({ opacity: 1, transform: 'perspective(400px) rotate3d(1, 0, 0, -20deg)', offset: 0.4 }),
...
export function flipOut(rotateX: number, rotateY: number): AnimationReferenceMetadata {
  return animation(
    [
      style({ 'backface-visibility': 'visible' }),
      animate(
        ...
        keyframes([
          ...
          style({ opacity: 1, transform: 'perspective(400px) rotate3d({{ rotateX }}, {{ rotateY }}, 0, -20deg)', offset: 0.3 }),
          style({ opacity: 0, transform: 'perspective(400px) rotate3d({{ rotateX }}, {{ rotateY }}, 0, 90deg)', offset: 1 })
        ])
      )
    ],
    { params: { timing: '500ms', delay: 0, rotateX, rotateY } }
