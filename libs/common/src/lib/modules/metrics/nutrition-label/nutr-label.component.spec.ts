...
describe('Nutrition Label Component', () => {
  ...
  beforeEach(() => {
    ...
    component = fixture.debugElement.query(By.directive(NutrLabelComponent)).componentInstance;
  ...
  it('Serving Size label is present', () => {
    expect(
      getDe(fixture, '.serving-size').nativeElement.textContent
    ).toContain('Serving Size 42 tons');
  });
